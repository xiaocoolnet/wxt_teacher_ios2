//
//  PhotoBigViewController.swift
//  WXT_Teacher
//
//  Created by xiaocool on 16/8/16.
//  Copyright © 2016年 北京校酷网络科技有限公司. All rights reserved.
//

import UIKit

class PhotoBigViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    var arrayInfo = Array<photopicInfo>()

//
//  GroupPictureViewController.swift
//  WXT_Teacher
//
...
class GroupPictureViewController: UIViewController ,UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    
    var arrayInfo = Array<NSendPicInfo>()

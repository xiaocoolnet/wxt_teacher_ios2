...
class AddHomeworkViewController: UIViewController ,UITableViewDelegate,UITableViewDataSource,UICollectionViewDataSource,UICollectionViewDelegate,sendnameidArray,sendSubiectDelegate,TZImagePickerControllerDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
//        HWtableview.reloadData()
    ...
    func UpdatePic(){
        ...
        if contentTextView.text!.isEmpty {
            messageHUD(self.view, messageData: "请输入作业内容!")
            return
        }
        if kechengL.text!.isEmpty || kechengL.text! == "选择课程"{
